...
const checks = [
  ...
  ['server/routes/studio.js', 'const liveBlock = await loadWebBlock()', 'Studio PPT uses current web context'],
  ['server/services/pptx.js', 'sanitizePptxArabicBuffer', 'Arabic PPTX post-processing sanitizer'],
